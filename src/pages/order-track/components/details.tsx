    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="shadow-lg py-0">
          <CardContent className="p-4 md:p-6 ">
            <h2 className="text-xl font-bold mb-4">
              {getTranslation("order_items") || "Order Items"}
            </h2>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        <span>{getTranslation("quantity") || "Quantity"}:</span>
                        <span className="font-semibold text-foreground">
                          {item?.quantity}
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        <span>{getTranslation("price") || "Price"}:</span>
                        <span className="font-semibold text-foreground">
                          {item?.price}
                        </span>
                      </div>
      ...
      <motion.div
        ...
        <Card className="shadow-lg sticky top-4">
          <CardContent className="p-4 md:p-6">
            <h2 className="text-xl font-bold mb-4">
              {getTranslation("order_summary") || "Order Summary"}
            </h2>
            ...
            <div className="space-y-4">
              <div className="space-y-2 pb-4 border-b">
                <div className="text-sm flex items-center justify-between gap-2">
                  <span className="text-muted-foreground">
                    {getTranslation("order_code") || "Order Code"}:
                  </span>
                ...
                <div className="text-sm flex items-center justify-between gap-2">
                  <span className="text-muted-foreground">
                    {getTranslation("order_date") || "Order Date"}:
                  </span>
                  <p className="font-semibold text-foreground">
              ...
              <div className="pb-4 border-b">
                <h3 className="text-sm font-semibold mb-2">
                  {getTranslation("shipping_address") || "Shipping Address"}
                </h3>
